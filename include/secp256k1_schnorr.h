 ...
 */
SECP256K1_EXPORT int secp256k1_schnorr_sign(
 ...
 */
SECP256K1_EXPORT SECP256K1_WARN_UNUSED_RESULT int secp256k1_schnorr_verify(
  const secp256k1_context_t* ctx,
 ...
 *                       be NULL)
 */
SECP256K1_EXPORT int secp256k1_schnorr_recover(
  const secp256k1_context_t* ctx,
 ...
 */
SECP256K1_EXPORT int secp256k1_schnorr_generate_nonce_pair(
  const secp256k1_context_t* ctx,
 ...
 */
SECP256K1_EXPORT SECP256K1_WARN_UNUSED_RESULT int secp256k1_schnorr_partial_sign(
  const secp256k1_context_t* ctx,
  unsigned char *sig64,
  const unsigned char *msg32,
  const unsigned char *sec32,
 ...
 */
SECP256K1_EXPORT SECP256K1_WARN_UNUSED_RESULT int secp256k1_schnorr_partial_combine(
  const secp256k1_context_t* ctx,
  unsigned char *sig64,

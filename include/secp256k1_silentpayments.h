 ...
 *           0 if label_tweak32 is an invalid scalar (stastically improbable).
 *  Args:                ctx: pointer to a context object
 ...
 *             or the spend pubkey + label sum to zero (stastically improbable).
 *  Args:                    ctx: pointer to a context object
 ...
 *             sum to zero (stastically improbable).
 *
 *  Args:                   ctx: pointer to a context object

 ...
 */
SECP256K1_EXPORT int secp256k1_ecdsa_recoverable_signature_parse_compact(
 ...
 */
SECP256K1_EXPORT int secp256k1_ecdsa_recoverable_signature_convert(
    const secp256k1_context_t* ctx,
 ...
 */
SECP256K1_EXPORT int secp256k1_ecdsa_recoverable_signature_serialize_compact(
    const secp256k1_context_t* ctx,
 ...
 */
SECP256K1_EXPORT int secp256k1_ecdsa_sign_recoverable(
    const secp256k1_context_t* ctx,
    secp256k1_ecdsa_recoverable_signature_t *sig,
 ...
 */
SECP256K1_EXPORT SECP256K1_WARN_UNUSED_RESULT int secp256k1_ecdsa_recover(
    const secp256k1_context_t* ctx,

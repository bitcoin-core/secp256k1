    ...
    /*** Receiving ***/
    {
...

        {
            ...
            }
            {
                ...
                if (!ret) {
                    printf("Something went wrong, the resulting label_tweak is not a valid scalar. Try again with m++.\n");
                    return EXIT_FAILURE;
                }
                ...
                if (!ret) {
                    printf("Something went wrong, the choice of label and spend public key is invalid.\n");
                    return EXIT_FAILURE;
                }
        ...
        }
        {
             ...
             *
             * In practice, Carol wouldn't know the number of found outputs ahead of

...
static void bench_ecmult(void* arg) {
    ...
    for (iter = 0; iter < iters; ++iter) {
        secp256k1_ecmult_multi(&data->ctx->ecmult_ctx, data->scratch, &data->ctx->error_callback, &data->output[iter], data->includes_g ? &data->scalars[data->offset1] : NULL, bench_callback, arg, count - includes_g);

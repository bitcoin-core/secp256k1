...
typedef void (*secp256k1_fn_sha256_compression)(uint32_t *state, const unsigned char *blocks64, size_t n_blocks);

typedef struct {
    secp256k1_fn_sha256_compression fn_sha256_compression;
} secp256k1_hash_ctx;

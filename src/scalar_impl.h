...
static void secp256k1_scalar_split_lambda(secp256k1_scalar *r1, secp256k1_scalar *r2, const secp256k1_scalar *a) {
    ...
    static const secp256k1_scalar minus_lambda = SECP256K1_SCALAR_CONST(
        UINT32_C(0xAC9C52B3), UINT32_C(0x3FA3CF1F), UINT32_C(0x5AD9E3FD), UINT32_C(0x77ED9BA4),
        UINT32_C(0xA880B9FC), UINT32_C(0x8EC739C2), UINT32_C(0xE0CFC810), UINT32_C(0xB51283CF)
    );
    static const secp256k1_scalar minus_b1 = SECP256K1_SCALAR_CONST(
        UINT32_C(0x00000000), UINT32_C(0x00000000), UINT32_C(0x00000000), UINT32_C(0x00000000),
        UINT32_C(0xE4437ED6), UINT32_C(0x010E8828), UINT32_C(0x6F547FA9), UINT32_C(0x0ABFE4C3)
    );
    static const secp256k1_scalar minus_b2 = SECP256K1_SCALAR_CONST(
        ...
        UINT32_C(0x8A280AC5), UINT32_C(0x0774346D), UINT32_C(0xD765CDA8), UINT32_C(0x3DB1562C)
    );
    static const secp256k1_scalar g1 = SECP256K1_SCALAR_CONST(
        UINT32_C(0x00000000), UINT32_C(0x00000000), UINT32_C(0x00000000), UINT32_C(0x00003086),
        UINT32_C(0xD221A7D4), UINT32_C(0x6BCDE86C), UINT32_C(0x90E49284), UINT32_C(0xEB153DAB)
    );
    static const secp256k1_scalar g2 = SECP256K1_SCALAR_CONST(
        UINT32_C(0x00000000), UINT32_C(0x00000000), UINT32_C(0x00000000), UINT32_C(0x0000E443),
        UINT32_C(0x7ED6010E), UINT32_C(0x88286F54), UINT32_C(0x7FA90ABF), UINT32_C(0xE4C42212)
    );
    VERIFY_CHECK(r1 != a);
    VERIFY_CHECK(r2 != a);

...
static int secp256k1_selftest_sha256(secp256k1_fn_sha256_transform fn_transform) {
    secp256k1_hash_context ctx;
    ...
    ctx.fn_sha256_transform = fn_transform;
    secp256k1_sha256_write(&hasher, (const unsigned char*)input63, 63, &ctx);
    secp256k1_sha256_finalize(&hasher, out, &ctx);
    return secp256k1_memcmp_var(out, output32, 32) == 0;
}

static int secp256k1_selftest_passes(void) {
    /* Use default sha256 transform */

...
static void secp256k1_musig_keyaggcoef_internal(const secp256k1_hash_context *hash_ctx, secp256k1_scalar *r, const unsigned char *pks_hash, secp256k1_ge *pk, const secp256k1_ge *second_pk) {
    ...
    if (!secp256k1_ge_is_infinity(second_pk)
        ...
        secp256k1_sha256_write(&sha, pks_hash, 32, hash_ctx);
        ...
        secp256k1_sha256_write(&sha, buf, sizeof(buf), hash_ctx);
        secp256k1_sha256_finalize(&sha, buf, hash_ctx);
...
static void secp256k1_musig_keyaggcoef(const secp256k1_hash_context *hash_ctx, secp256k1_scalar *r, const secp256k1_keyagg_cache_internal *cache_i, secp256k1_ge *pk) {

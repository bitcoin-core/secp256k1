...
/* Helpers for modules implementing interactive signing protocols with
 * two-point nonces, factored out of the musig module so that they can be
 * shared. The magic argument identifies the type of the opaque object being
 * (de)serialized so that passing an object to the wrong API fails. */

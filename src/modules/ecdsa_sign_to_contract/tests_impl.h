...
static void test_ecdsa_s2c_api(void) {
    ...
    { /* anti_nonce_covert_channel_client_commit: ctx */
        ...
        unsigned char rand_commitment[32] = {0};
        ecount = 0;
    ...
    { /* anti_nonce_covert_channel_host_verify */
        unsigned char host_nonce[32] = {0};
        unsigned char host_commitment[32] = {0};
    ...
    { /* anti_nonce_covert_channel_host_commit */
        unsigned char rand_commitment[32];
        unsigned char rand[32] = {1};
        ecount = 0;

...
#ifndef SECP256K1_MODULE_SHA_MAIN_H
#define SECP256K1_MODULE_SHA_MAIN_H

#if !defined(SECP256K1_EXTERNAL_SHA256)
...
void secp256k1_sha256_transform(uint32_t *state, const unsigned char *block, size_t rounds) {
...
#endif /* !SECP256K1_EXTERNAL_SHA256 */

#endif /* SECP256K1_MODULE_SHA_MAIN_H */

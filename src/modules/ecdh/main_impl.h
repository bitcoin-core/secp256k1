...
static int ecdh_hash_function_sha256_impl(const secp256k1_context *ctx, unsigned char *output, const unsigned char *x32, const unsigned char *y32, void *data) {
    unsigned char version = (y32[31] & 0x01) | 0x02;
    secp256k1_sha256 sha;
    (void)data;

    secp256k1_sha256_initialize(&sha);
    secp256k1_sha256_write(&sha, &version, 1, secp256k1_get_hash_context(ctx));
...
static int ecdh_hash_function_sha256(unsigned char *output, const unsigned char *x32, const unsigned char *y32, void *data) {
    return ecdh_hash_function_sha256_impl(secp256k1_context_static, output, x32, y32, data);
}
...
int secp256k1_ecdh(const secp256k1_context* ctx, unsigned char *output, const secp256k1_pubkey *point, const unsigned char *scalar, secp256k1_ecdh_hash_function hashfp, void *data) {
    ...
    if (hashfp == NULL) {
        ...
        ret = ecdh_hash_function_sha256_impl(ctx, output, x, y, data);
    } else {

...
static int ellswift_xdh_hash_function_prefix_impl(const secp256k1_hash_context *hash_ctx, unsigned char *output, const unsigned char *x32, const unsigned char *ell_a64, const unsigned char *ell_b64, void *data) {
    secp256k1_sha256 sha;

    secp256k1_sha256_initialize(&sha);
    secp256k1_sha256_write(&sha, data, 64, hash_ctx);
    secp256k1_sha256_write(&sha, ell_a64, 64, hash_ctx);
    secp256k1_sha256_write(&sha, ell_b64, 64, hash_ctx);
    secp256k1_sha256_write(&sha, x32, 32, hash_ctx);
    secp256k1_sha256_finalize(&sha, output, hash_ctx);
...
static int ellswift_xdh_hash_function_bip324_impl(const secp256k1_hash_context *hash_ctx, unsigned char* output, const unsigned char *x32, const unsigned char *ell_a64, const unsigned char *ell_b64, void *data) {
    secp256k1_sha256 sha;

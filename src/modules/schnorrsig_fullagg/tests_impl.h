...
static void fullagg_simple_test(void) {
...
static void run_schnorrsig_fullagg_tests(void) {
    int i;
    ...
    fullagg_api_tests();
    fullagg_nonce_gen_counter_test();
    fullagg_serialization_test();
    fullagg_duplicate_pubnonce_test();
}

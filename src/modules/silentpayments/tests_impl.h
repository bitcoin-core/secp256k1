...
static void test_recipient_api(void) {
    ...
    secp256k1_silentpayments_recipient_public_data md; /* malformed public data */
     ...
     */
    pp[0] = &malformed_p;
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_public_data_create(CTX, &pd, SMALLEST_OUTPOINT, tp, 1, pp, 1));
    ...
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_public_data_serialize(CTX, o, &md));

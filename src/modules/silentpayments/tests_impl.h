...
static void test_recipient_api(void) {
    ...
    unsigned char o33[33];                        /* serialized prevouts_summary, serialized shared secret */
    ...
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_prevouts_summary_serialize(CTX, NULL, 33, &pd, SECP256K1_EC_COMPRESSED));
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_prevouts_summary_serialize(CTX, o33, 33, NULL, SECP256K1_EC_COMPRESSED));
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_prevouts_summary_serialize(CTX, o33, 33, &pd, 101));
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_prevouts_summary_serialize(CTX, o33, 65, &pd, SECP256K1_EC_COMPRESSED));
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_prevouts_summary_serialize(CTX, o33, 33, &pd, SECP256K1_EC_UNCOMPRESSED));
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_prevouts_summary_serialize(CTX, o33, 0, &pd, SECP256K1_EC_COMPRESSED));
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_prevouts_summary_parse(CTX, NULL, o33, 33));
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_prevouts_summary_parse(CTX, &pd, NULL, 33));
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_prevouts_summary_parse(CTX, &pd, o33, 0));

    /* Check that serializing or using a malformed, i.e., not created by us, prevouts_summary object fails */
    CHECK_ILLEGAL(CTX, secp256k1_silentpayments_recipient_prevouts_summary_serialize(CTX, o33, 33, &md, SECP256K1_EC_COMPRESSED));

    /* Check that malformed serializations are rejected */
    CHECK(secp256k1_silentpayments_recipient_prevouts_summary_parse(CTX, &pd, malformed, 33) == 0);
    ...
    CHECK(secp256k1_silentpayments_recipient_prevouts_summary_serialize(CTX, o33, 33, &pd, SECP256K1_EC_COMPRESSED));
    CHECK(secp256k1_silentpayments_recipient_prevouts_summary_serialize(CTX, o65, 65, &pd, SECP256K1_EC_UNCOMPRESSED));
    CHECK(secp256k1_silentpayments_recipient_prevouts_summary_parse(CTX, &pd, o33, 33));
    CHECK(secp256k1_silentpayments_recipient_prevouts_summary_parse(CTX, &pd, o65, 65));
    ...
    /* check the _recipients_scan_outputs cornercase where the output_tweak is the negation of the label_tweak */
    {
        ...
        found = 0;
        CHECK(secp256k1_silentpayments_recipient_scan_outputs(CTX, fp, &found, output_xonly_ptrs, 1, ALICE_SECKEY, &pd, &spk, &label_lookup, &labels_cache));
        CHECK(found == 1);

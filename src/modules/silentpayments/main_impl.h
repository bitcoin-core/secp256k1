...
static int secp256k1_silentpayments_create_output_pubkeys(const secp256k1_context *ctx, secp256k1_xonly_pubkey **outputs_xonly, const unsigned char *shared_secret33, const secp256k1_pubkey **spend_pubkeys, size_t n_spend_pubkeys, uint32_t k) {
...
int secp256k1_silentpayments_sender_create_outputs(
    ...
    secp256k1_xonly_pubkey *generated_output_ptrs[1];
    int ret, sum_is_zero;
...
int secp256k1_silentpayments_recipient_prevouts_summary_serialize(const secp256k1_context *ctx, unsigned char *output, size_t size, const secp256k1_silentpayments_prevouts_summary *prevouts_summary, unsigned int flags) {
    secp256k1_ge ge;
...
int secp256k1_silentpayments_recipient_prevouts_summary_parse(const secp256k1_context *ctx, secp256k1_silentpayments_prevouts_summary *prevouts_summary, const unsigned char *input, size_t inputlen) {
    ...
    if (!secp256k1_eckey_pubkey_parse(&pk, input, inputlen)) {
        return 0;
    }

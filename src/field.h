...
/** Sets a field element to be the (modular) square root (if any exist) of another. Requires the inputs'
 *  magnitude to be at most 8. The output magnitude is 1 (but not guaranteed to be normalized). Return
 *  value indicates whether a square root was found. */

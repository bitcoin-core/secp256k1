...
static void secp256k1_ecmult_gen_context_build(secp256k1_ecmult_gen_context *ctx, const secp256k1_hash_context *ctx_hash) {
    secp256k1_ecmult_gen_blind(ctx, NULL, ctx_hash);
    ctx->built = 1;
}
...
static void secp256k1_ecmult_gen_blind(secp256k1_ecmult_gen_context *ctx, const unsigned char *seed32, const secp256k1_hash_context *ctx_hash) {
    secp256k1_scalar b;
    ...
    secp256k1_rfc6979_hmac_sha256_initialize(&rng, keydata, 64, ctx_hash);
    secp256k1_memclear_explicit(keydata, sizeof(keydata));

    /* Compute projective blinding factor (cannot be 0). */
    secp256k1_rfc6979_hmac_sha256_generate(&rng, nonce32, 32, ctx_hash);
